...
import pandas as pd
# Example parameters:
#   --predicted_events_csv=demo_data/demo_video_rotate_perfect_predicted_events.csv
#   --ground_truth_csv=demo_data/demo_video_rotate_only_ground_truth.csv
...
def read_command_line_arguments():
    ...
    parser.add_argument("--predicted_events_csv",
...
def read_data(args):
    events = pd.read_csv(args.predicted_events_csv)
